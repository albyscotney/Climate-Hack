...
from model import UNetPPDropoutMultiBigBoi
...
class Evaluator(BaseEvaluator):
    def setup(self):
        ...
        self.model = UNetPPDropoutMultiBigBoi()
    ...
    def predict(self, coordinates: np.ndarray, data: np.ndarray) -> np.ndarray:
        ...
        with torch.no_grad():
            ...
            prediction[12:24] = np.rint(prediction[12:24])
...
# Playing with other models, credit to pmistry9597